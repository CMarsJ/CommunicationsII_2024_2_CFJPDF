...
class Lab_Comu_II_APLI(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_0_1.set_title("Señal Derivada")
        ...
        self.qtgui_number_sink_0_0.set_title("Señal Integrada")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 50, 4, (-2), 1.57)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.epy_block_1_1, 0))
        ...
        self.connect((self.epy_block_1_1, 0), (self.epy_block_0_1, 0))
        self.connect((self.epy_block_1_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
