...
import Lab_Comu_II_Pro_epy_block_0 as epy_block_0  # embedded python block
import sip



class Lab_Comu_II_Pro(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_Comu_II_Pro", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_Comu_II_Pro")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_Comu_II_Pro")
        ...
        self.qtgui_number_sink_3.set_title("Potencia promedio de la señal")
        ...
        self.qtgui_number_sink_2.set_title("Desviacion estandar de la señal")
        ...
        self.qtgui_number_sink_1.set_title("RMS de la señal")
...
def main(top_block_cls=Lab_Comu_II_Pro, options=None):
