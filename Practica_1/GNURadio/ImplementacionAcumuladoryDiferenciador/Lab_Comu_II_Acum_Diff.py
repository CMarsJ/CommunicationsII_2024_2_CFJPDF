...
class Lab_Comu_II_Acum_Diff(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_2_1.set_y_axis(-2, 2)
        ...
        self.qtgui_time_sink_x_0.set_y_axis(-70, 70)

        self.qtgui_time_sink_x_0.set_y_label('Amplitude Acumu', "")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 1000, 4, (-2), 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, 4, (-2), 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.qtgui_time_sink_x_2_1, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.epy_block_1, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.qtgui_time_sink_x_2_0, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.epy_block_0, 0), (self.qtgui_time_sink_x_2_1, 1))
